...
Object-detection accelerator for the YOLO family: one convolution engine, YOLO26 n/s/m/l/x as a parameter.
...
Planned, not started. Work starts once the design questions in the project notes are answered by experiment. The target is FPGA.
